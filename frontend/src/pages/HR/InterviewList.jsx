        ...
        <div className="flex flex-1">
          <div className="w-64 bg-gray-800 text-white h-full">
            ...
            <span className="mr-2">🏠</span> HR Dashboard
              ...
              <button onClick={() => navigateTo('/interviews')} className="flex items-center p-4 bg-blue-600 hover:bg-blue-600">
          ...
          <div className="flex-1 p-6">
            <div className="space-y-4">
              <h2 className="text-2xl font-bold text-center text-gray-800">Manage Interviews</h2>
