        ...
        <div className="flex flex-1 flex-col w-full">
          <nav className="bg-gradient-to-r from-teal-800 to-blue-900 text-white p-6 flex justify-between items-center shadow-lg backdrop-blur-md">
            <div className="flex items-center">
              ...
              <span className="text-md">{new Date('2025-09-26T17:53:00+05:30').toLocaleString('en-US', { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric', hour: '2-digit', minute: '2-digit', timeZoneName: 'short', hour12: true })}</span>
            </div>
            <div className="flex items-center">
          ...
          <div className="flex-1 flex items-center justify-center">
            <div className="text-center">
              ...
              <p className="mt-6 text-gray-600 text-lg">Loading interview report...</p>
            </div>
          </div>
        </div>
      </div>
    ...
    return (
      <div className="flex min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-teal-50 font-sans overflow-hidden">
        <div className="flex flex-1 flex-col w-full">
          ...
          <div className="flex-1 flex items-center justify-center">
            <div className="text-center">
              <p className="text-gray-600 text-xl">No feedback found for this interview.</p>
              <motion.button whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} onClick={() => navigate('/admin/view-interviews')} className="mt-6 bg-teal-600 text-white px-6 py-3 rounded-xl hover:bg-teal-700 focus:ring-2 focus:ring-teal-500">
                Back to Interviews
              </motion.button>
            </div>
          </div>
          ...
          <div className="flex-1 p-10 overflow-auto">
            <motion.div initial="hidden" animate="visible" variants={containerVariants} className="max-w-4xl mx-auto bg-white/80 backdrop-blur-md p-8 rounded-3xl shadow-2xl border border-white/20">
              <div className="flex justify-between items-center mb-8">
                <h2 className="text-3xl font-bold text-gray-800 bg-gradient-to-r from-teal-600 to-blue-600 bg-clip-text text-transparent">Interview Report - {candidate?.firstName} {candidate?.lastName}</h2>
                <motion.button whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} onClick={() => navigate('/admin/view-interviews')} className="bg-gray-600 text-white px-6 py-3 rounded-xl hover:bg-gray-700 focus:ring-2 focus:ring-gray-500 transition duration-200">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-6">
                    {[
                      ...
                      <div key={item.label} className="flex justify-between items-center p-4 bg-teal-50 rounded-lg shadow-md">
                        ...
                        <div className="flex items-center">
                          ...
                          <span className="text-yellow-500 text-xl">{getRatingStars(item.value)}</span>
                        </div>
                      </div>
                    ))}
                  </div>
                  <div className="space-y-6">
                    <div className="p-4 bg-teal-50 rounded-lg shadow-md">
                      <div className="flex justify-between items-center mb-4">
                        ...
                        <span className="text-2xl font-bold text-teal-700">{feedback.overallRating}/5</span>
                      </div>
                      <div className="w-full bg-gray-200 rounded-full h-4">
                        <div className="bg-teal-600 h-4 rounded-full" style={{ width: `${(feedback.overallRating / 5) * 100}%` }}></div>
                      </div>
                    </div>
                    <div className="p-4 bg-teal-50 rounded-lg shadow-md">
              ...
              {feedback.notes && (
                <motion.div variants={itemVariants} className="mb-8">
                  ...
                  <div className="p-6 bg-teal-50 rounded-xl shadow-md">
              ...
              <motion.div variants={itemVariants} className="flex space-x-6 pt-8 border-t border-gray-200">
                <motion.button whileHover={{ scale: 1.05, boxShadow: '0 10px 25px rgba(20, 184, 166, 0.3)' }} whileTap={{ scale: 0.95 }} onClick={() => window.print()} className="bg-gradient-to-r from-teal-600 to-blue-600 text-white px-6 py-3 rounded-xl hover:from-teal-700 hover:to-blue-700 focus:ring-2 focus:ring-teal-500 transition duration-200">
                  Print Report
                </motion.button>
              </motion.div>
            </motion.div>
